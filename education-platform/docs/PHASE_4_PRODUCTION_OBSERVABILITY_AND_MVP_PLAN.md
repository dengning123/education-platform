...
capability under the separately reviewed provisional Migration 031 contract.
...
provisional future Migration 031 identity; that number remains provisional
...
- later Application/Outcome commands only after provisional Migration 031 is
...
- Migration 031 receives independent design approval and implementation
  authorization;
- clean `001→031`, populated `030→031`, RLS, concurrency, privacy, and remote
  smoke gates pass;
