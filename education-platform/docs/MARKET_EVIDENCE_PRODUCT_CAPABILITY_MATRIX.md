...
| Application Tracking | Medium | Medium after shortlist | Seasonal/repeated | Medium | Student-supplied operational data | Medium; strategically useful for future outcomes | Provisional Migration 027 plan only | Complete decision loop first; separately review and implement later | LATER | E09 | Planning-only; no SQL/runtime |
