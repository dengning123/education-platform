...
test("explain output includes reasons, prerequisites, order, and heavy classification", () => {
  ...
  assert.match(output, /why: Prove the full PostgreSQL 15 non-superuser clean migration runner path through Migration 026\./);
  assert.match(output, /db\.pg15-clean-001-026-non-super \[heavy\]/);
